...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('channels_subscription', (
            ...
            ('email_frequency', self.gf('django.db.models.fields.CharField')(default='weekly', max_length=12)),
        ))
        db.send_create_signal('channels', ['Subscription'])

        # Deleting field 'Channel.title'
        db.delete_column('channels_channel', 'title')

        # Deleting field 'Channel.image'
        db.delete_column('channels_channel', 'image')

        # Adding field 'Channel.name'
        db.add_column('channels_channel', 'name', self.gf('django.db.models.fields.CharField')(default='bla', max_length=255), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Channel.title'
        raise RuntimeError("Cannot reverse this migration. 'Channel.title' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Channel.image'
        raise RuntimeError("Cannot reverse this migration. 'Channel.image' and its values cannot be restored.")

        # Deleting field 'Channel.name'
        db.delete_column('channels_channel', 'name')
    ...
    models = {
        ...
        'channels.subscription': {
            ...
            'email_frequency': ('django.db.models.fields.CharField', [], {'default': "'weekly'", 'max_length': '12'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
