...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('wiki_page', 'language', self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['channels.Language']), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 21, 2, 50, 43, 521697)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 21, 2, 50, 43, 521416)'}),
        ...
        'wiki.page': {
            ...
            'translated_pages': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'translated_pages_rel_+'", 'to': "orm['wiki.Page']"})
        }
    }
