...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Adding M2M table for field translated_pages on 'Page'
        db.create_table('wiki_page_translated_pages', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_page', models.ForeignKey(orm['wiki.page'], null=False)),
            ('to_page', models.ForeignKey(orm['wiki.page'], null=False))
        ))
        db.create_unique('wiki_page_translated_pages', ['from_page_id', 'to_page_id'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 21, 2, 55, 47, 324797)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 21, 2, 55, 47, 324571)'}),
        ...
        'wiki.page': {
            ...
            'translation_of': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'translation_of_rel_+'", 'to': "orm['wiki.Page']"})
        }
    }
