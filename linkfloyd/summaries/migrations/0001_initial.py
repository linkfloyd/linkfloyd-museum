...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Unseen'
        db.create_table('summaries_unseen', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('link', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['links.Link'])),
        ))
        db.send_create_signal('summaries', ['Unseen'])


    def backwards(self, orm):
        
        # Deleting model 'Unseen'
        db.delete_table('summaries_unseen')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 1, 10, 17, 34, 882714)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 1, 10, 17, 34, 882606)'}),
