...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Link.thumbnail_offset'
        db.add_column('links_link', 'thumbnail_offset', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True), keep_default=False)
        ...
        db.alter_column('links_link', 'title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Deleting field 'Link.thumbnail_offset'
        db.delete_column('links_link', 'thumbnail_offset')

        # Changing field 'Link.description'
        db.alter_column('links_link', 'description', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 25, 16, 19, 52, 287154)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 25, 16, 19, 52, 287043)'}),
