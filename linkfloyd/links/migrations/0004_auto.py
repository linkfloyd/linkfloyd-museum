...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field followers on 'Channel'
        db.delete_table('links_channel_followers')
    ...
    def backwards(self, orm):
        ...
        # Adding M2M table for field followers on 'Channel'
        db.create_table('links_channel_followers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('channel', models.ForeignKey(orm['links.channel'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('links_channel_followers', ['channel_id', 'user_id'])
