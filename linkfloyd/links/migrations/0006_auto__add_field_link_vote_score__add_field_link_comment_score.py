...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Link.vote_score'
        db.add_column('links_link', 'vote_score', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'Link.comment_score'
        db.add_column('links_link', 'comment_score', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Link.vote_score'
        db.delete_column('links_link', 'vote_score')

        # Deleting field 'Link.comment_score'
        db.delete_column('links_link', 'comment_score')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 20, 12, 38, 38, 219154)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 20, 12, 38, 38, 219038)'}),
