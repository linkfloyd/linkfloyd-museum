...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Link.gravity'
        db.delete_column('links_link', 'gravity')

        # Adding field 'Link.updated_at'
        db.add_column('links_link', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Link.gravity'
        db.add_column('links_link', 'gravity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Link.updated_at'
        db.delete_column('links_link', 'updated_at')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 15, 12, 57, 2, 422132)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 15, 12, 57, 2, 422017)'}),
