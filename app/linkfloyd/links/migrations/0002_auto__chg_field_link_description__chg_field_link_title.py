...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('links_link', 'description', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Link.title'
        db.alter_column('links_link', 'title', self.gf('django.db.models.fields.CharField')(max_length=144))


    def backwards(self, orm):
        
        # Changing field 'Link.description'
        db.alter_column('links_link', 'description', self.gf('django.db.models.fields.CharField')(max_length=4096, null=True))

        # Changing field 'Link.title'
        db.alter_column('links_link', 'title', self.gf('django.db.models.fields.CharField')(max_length=2048))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 10, 5, 12, 32, 977508)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 10, 5, 12, 32, 977390)'}),
