...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Link.is_sponsored'
        db.add_column('links_link', 'is_sponsored', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Link.is_sponsored'
        db.delete_column('links_link', 'is_sponsored')
