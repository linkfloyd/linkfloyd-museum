...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Link.updated_at'
        db.alter_column('links_link', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2012, 4, 15)))


    def backwards(self, orm):
        
        # Changing field 'Link.updated_at'
        db.alter_column('links_link', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 15, 13, 4, 15, 270642)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 15, 13, 4, 15, 270527)'}),
